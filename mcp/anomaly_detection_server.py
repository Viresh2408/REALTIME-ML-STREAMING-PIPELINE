...
@server.tool()
async def get_anomaly_rate(bucket: str = "1h", source_id: str | None = None) -> list[dict[str, Any]]:
...
@server.tool()
async def acknowledge_alert(alert_id: str, analyst_id: str, note: str | None = None) -> dict[str, Any]:
